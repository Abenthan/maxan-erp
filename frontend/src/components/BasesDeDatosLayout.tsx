...
const SIDEBAR_ITEMS = [
  { to: "/bases-de-datos/terceros", label: "Terceros", icon: "👤", permiso: "terceros.ver" },
  { to: "/bases-de-datos/contactos", label: "Contactos", icon: "📇", permiso: "helpdesk.casos.ver" },
];

export default function BasesDeDatosLayout({ children }: { children: ReactNode }) {
    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-56 bg-white border-r border-gray-200 flex flex-col shrink-0">
        <div className="h-14 flex items-center px-5 border-b border-gray-200">
          <Link to="/" className="text-lg font-bold text-gray-800 hover:text-teal-600">Maxan ERP</Link>
        </div>
        <nav className="flex-1 p-3 space-y-3 overflow-y-auto">
          <div className="bg-teal-50 rounded-xl p-2 space-y-0.5">
